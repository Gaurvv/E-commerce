  ...
  return (
    <div className="sticky top-0 z-50 flex items-center justify-between bg-gray-100 px-3 sm:px-6 py-2 sm:py-3 shadow-md relative">
      ...
      <div className="flex items-center space-x-3 sm:space-x-5">
        ...
        <NavLink to="/cart">
          <MdOutlineShoppingCart className={`${iconClass} text-2xl sm:text-3xl hover:scale-110 transition`} />
        </NavLink>

        <div onClick={handleSettingsClick}>
          <MdSettings className={`${iconClass} text-2xl sm:text-3xl hover:scale-110 transition`} />
        </div>
